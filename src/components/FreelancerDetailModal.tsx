import { MapPin, Lock, Briefcase, Crown, ShieldCheck, Diamond, MessageCircle, Phone, DollarSign, User as UserIcon } from 'lucide-react';
      ...
      <div className="flex items-start gap-4">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="mt-1 flex items-center gap-3 text-xs text-neutral-400">
            <span className="inline-flex items-center gap-1"><MapPin className="h-3.5 w-3.5" /> {showIdentity ? `${f.address.city}, ${f.address.state}` : 'Região Metropolitana'}</span>
          </div>
        </div>
      </div>
