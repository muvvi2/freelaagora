...
import {
  ...
  Search, Star, X, UserPlus, Eye, EyeOff, UserCog, Camera, Lock, DollarSign, MoreVertical, ChevronDown,
  CreditCard,
} from 'lucide-react';
...
import { formatCurrency, formatDate, formatDateTime, contractStatusLabel, getPlan, getEstPlan, maskCEP, maskCPF, maskCNPJ, maskDocumentDisplay, periodLabel } from '@/utils';
import type { Contract, User, Tier, EstTier, ContractStatus, ShiftSlot, Period, AccountType, VipPlan, EstVipPlan, PaymentProviderId, PaymentProviderConfig, PaymentSettings } from '@/types';
...
export function AdminView() {
  const { data, currentUser, isSuperAdmin, setDefaultFeePercent, overrideContractStatus, forceRefund, resetData, banUser, unbanUser, deleteEntity, adminWalletTxs, coupons, addCoupon, toggleCoupon, deleteCoupon, auditLogs, adminCreateUser, adminCreateAdmin, removeAdmin, adjustWallet, deleteReview, broadcastNotification, deleteJob, updateJob, updateUser, updateVipPlan, addVipPlan, removeVipPlan, updateEstVipPlan, addEstVipPlan, removeEstVipPlan, updatePaymentSettings, adminTab: tab } = useApp();
    ...
    <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
      ...
      {tab === 'overview' && (
        <div className="space-y-5">
          ...
          {/* Revenue breakdown by subscription + fees */}
